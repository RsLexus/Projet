...
int AffichageMenu() // Fonction permettant d'afficher un menu dans la console.
{
    ...
    void nbrchoisi(int a, Battements *tab, int y) // Fonction qui effectue les différents cas en fonction de ce que l'utilisateur avait rentré comme chiffre.
    {
        switch (a)
        {
            ...
            AfficherOrdreDecroiPouls(); // ...on exécute cette fonction située dans action.c/h.
            break;
            case 6: // Si la valeur rentrée est 6 alors...
            RechercheDonnees(); // ...on exécute cette fonction située dans action.c/h.
            break;
            case 7: // Si la valeur rentrée est 7 alors...
            AffichageMoyenne(); // ...on exécute cette fonction située dans action.c/h.
            break;
            ...
            AffichageMaxPouls();// ...on exécute cette fonction située dans action.c/h.
            break;
            case 10: // Si la valeur rentrée est 7 alors...
            AffichageMinPouls();// ...on exécute cette fonction située dans action.c/h.
            break;
        }
    }
